...
See [`index.md`](./index.md) for the full layout and [`context/issue-format.md`](./context/issue-format.md) for the format spec — `index.md` is the entry point a winter workspace routes to when this extension is installed, and everything else is one link away from it.
